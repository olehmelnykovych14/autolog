...
export function CarReportModal({ car, historyList, onClose }) {
  ...
  return (
    <Modal title="Carfax-AutoLog Звіт" onClose={onClose}>
      <div className="flex flex-col gap-6 print:p-0">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-5 bg-gray-50 dark:bg-gray-900/30 rounded-2xl border border-gray-100 dark:border-gray-700/60">
            ...
            <p className="text-2xl font-black text-green-500">CLEAN</p>
          </div>
        </div>
        ...
        <div className="flex gap-3 mt-4 print:hidden">
          <button onClick={print} className="flex-1 py-4 bg-gray-900 text-white rounded-2xl font-black text-sm flex items-center justify-center gap-3 hover:bg-gray-800 transition-all shadow-xl shadow-gray-400/20 active:scale-95">
            <Printer size={18} /> ДРУКУВАТИ ЗВІТ
          </button>
          <button className="flex-1 py-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-2xl font-black text-sm flex items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all border border-gray-200 dark:border-gray-700 active:scale-95">
