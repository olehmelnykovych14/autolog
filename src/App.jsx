...
export default function App() {
  ...
  return (
    <ThemeCtx.Provider value={isDark}>
      <div className={`fixed inset-0 flex font-sans overflow-hidden bg-white dark:bg-gray-950 text-gray-900 dark:text-white ${isDark ? 'dark' : ''}`}>
        ...
        <div className="flex flex-1 flex-col min-h-0 relative bg-white dark:bg-gray-900 overflow-hidden">
